(function ($) {
  ...
  function mainMap() {
    function locationData(
      ...
      return (
        '<div class="map-popup-wrap"><div class="map-popup"><div class="map-popup-status mp-cat  color-bg">' +
        locationStatus +
        '</div><div class="map-popup-category mp-cat  color-bg">' +
        locationCategory +
        '</div><div class="infoBox-close"><i class="fal fa-times"></i></div> <a href="' +
        locationURL +
        '" class="listing-img-content" style="background-image: url(' +
        locationImg +
        ')"> </a> <div class="listing-content">  <div class="listing-title">   <h4><a href=' +
        locationURL +
        ">" +
        locationTitle +
        '</a></h4><span class="map-popup-location-info"> ' +
        locationAddress +
        '</span> </div><span class="map-popup-price fl-wrap">  $' +
        locationPrice +
        "  </span></div>    </div></div>"
      );
    }
    ...
    var locations = [
      ...
      [
        locationData(
          ...
          "Office",
          "images/all/7.jpg",
          "New York Office Center",
          "1-30 Hunters Point Ave, Long Island City, NY",
          "510 / per month",
          "Rent"
        ),
        40.58110616,
      ...
      [
        locationData(
          "listing-single3.html",
          "Hotel",
          "images/all/27.jpg",
          "Apartment to rent in Queens",
          "726-1728 2nd Ave, New York, NY",
          "1800 / per month",
          "Rent"
        ),
        40.73112881,
      ...
      [
        locationData(
          ...
          "9443 Fairview Ave, North Bergen, NJ",
          "800.000",
          "Sale"
        ),
        40.67386831,
