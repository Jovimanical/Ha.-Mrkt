...
export class ThemeService {
  ...
  toggleDarkTheme(): void {
    ...
    if (this.darkTheme) {
      this.overlayContainer.getContainerElement().classList.add('house-africa-theme-dark');
    } else {
      this.overlayContainer.getContainerElement().classList.remove('house-africa-theme-dark');
    }
