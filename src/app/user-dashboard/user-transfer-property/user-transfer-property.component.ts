...
@Component({
  selector: 'app-user-transfer-property',
  templateUrl: './user-transfer-property.component.html',
...
export class UserTransferPropertyComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.propertyActionSub = this.eventService.subscribe("TRANSFER:PROPERTY", async (data: any) => {
