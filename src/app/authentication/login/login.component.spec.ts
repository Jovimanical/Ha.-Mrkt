...
describe('LoginComponent', () => {
  ...
  describe('when calling login()', () => {
    ...
    it('should return if the form is invalid', () => {
      spyOn(loginService, 'loginAction');
      component.login();
      expect(loginService.loginAction).not.toHaveBeenCalled();
    });

    it('should call the login service if the form is valid', () => {
      component.loginForm.controls['username'].setValue('username');
      component.loginForm.controls['password'].setValue('password');
      spyOn(loginService, 'loginAction').and.callFake(() => new Observable(o => o.next()));
      component.login();
      expect(loginService.loginAction).toHaveBeenCalled();
    });
  });
